...
// Re-export the t! macro from crate root (generated by rust_i18n::i18n! in lib.rs)
pub use crate::t;
...
///
/// This is a convenience wrapper around the `t!` macro that handles
/// parameter substitution for dynamic values.
///
/// # Examples
///
/// ```
/// let msg = format_i18n("approval_approve_host", &[("host", "example.com")]);
/// // Returns: "Do you want to approve access to \"example.com\"?" (en)
/// // Or: "是否允许访问 \"example.com\"？" (zh)
/// ```
pub fn format_i18n(key: &str, params: &[(&str, &str)]) -> String {
